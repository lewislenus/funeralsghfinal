  ...
  const faqs = [
    {
      ...
      answer:
        "Simply sign up for an account, then use our intuitive dashboard to create a beautiful funeral page with photos, biography, and service details.",
    },
    {
      question: "Is the platform free to use?",
      answer:
        "Yes, basic funeral pages are completely free. We offer premium features for enhanced customization and additional services.",
    },
    {
      question: "How secure are donations?",
      answer:
        "All donations are processed through secure, encrypted payment gateways. We use bank-level security to protect all transactions.",
    },
    {
      question: "Can I moderate condolence messages?",
      answer:
        "Yes, as a funeral organizer, you have full control to moderate and approve condolence messages before they appear publicly.",
    },
  ];
  return (
          ...
          <div className="container mx-auto px-4 relative z-10">
            ...
            >
              ...
              <p className="text-xl md:text-2xl text-slate-300 leading-relaxed mb-8">
                We're here to support you during difficult times. Reach out to
                us anytime for assistance, questions, or just to talk.
              </p>
