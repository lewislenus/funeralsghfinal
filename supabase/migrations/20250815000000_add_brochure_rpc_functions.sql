-- Add RPC functions for brochure management
-- Migration: 20250815000000_add_brochure_rpc_functions.sql
...
BEGIN
  UPDATE brochures SET
    ...
    cloudinary_url = COALESCE((updates->>'cloudinary_url')::TEXT, cloudinary_url),
